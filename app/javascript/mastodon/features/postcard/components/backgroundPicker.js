...
function BackgroundPicker(props) {
  ...
  if (props.fileName) {
    ...
    <div id='dark-light-radio'>
        ...
        <label><input
        type='radio' name='dark-light' onClick={() => {
          setImgFilter('dark'); setBoxBackground(false); setBoxShadow(false);
        }} defaultChecked={imgFilter === 'dark'}
      /> Dark</label>
        <label><input
        type='radio' name='dark-light' onClick={() => {
          setImgFilter('light'); setBoxBackground(false); setBoxShadow(false);
        }} defaultChecked={imgFilter === 'light'}
      /> Light</label>
      </div>
    </>);
  } else {
    ...
    <>
      ...
      <div className='segmented'>
        <input type='radio' name='color-mode' id='solid' defaultChecked={colorMode == 0} /><label
          ...
          htmlFor='solid'
          onClick={() => {
            setBoxBackground(true); setColorMode(0);
          }}
        ...
        <input type='radio' name='color-mode' id='gradient' defaultChecked={colorMode == 1} /><label
          ...
          htmlFor='gradient'
          onClick={() => {
            setBoxBackground(true); setColorMode(1);
          }}
