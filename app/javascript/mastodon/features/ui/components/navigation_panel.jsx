...
//like
import WavingHand from '@/material-icons/400-24px/waving_hand.svg?react';
import BitcoinIcon from '@/material-icons/400-24px/bitcoin.svg?react';
//
      ...
      <div className='navigation-panel'>
        ...
        {signedIn && (
          <>
            ...
            <ColumnLink  iconComponent={WavingHand} transparent to='/liker-id' icon='WavingHand' text={`Liker Id (${this.props.liker_id})`} />

            <ColumnLink  iconComponent={BitcoinIcon} transparent to='/crypto-hub' icon='bitcoin' text={'Crypto Hub'} />
            <ListPanel />
