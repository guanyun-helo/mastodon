...
class Api::V1::Statuses::SuperlikesController < Api::BaseController
    ...
    def like_content(path,count)
      ...
      url = URI("https://api.like.co/like/share/#{Account.find(@status['account_id'])['liker_id']}/?tz=#{params['tz']}&referrer=#@referrer&parentSuperLikeID=#{params['parentSuperLikeID']}")
