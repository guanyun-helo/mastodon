...
Rails.application.config.content_security_policy do |p|
  ...
  if Rails.env.development?
    ...
    p.connect_src :self, :data, :blob, assets_host, like_co, coingecko, like_pay, gam, gam_http, media_host, Rails.configuration.x.streaming_api_base_url, *webpacker_urls
