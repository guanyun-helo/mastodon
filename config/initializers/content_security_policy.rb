...
Rails.application.config.content_security_policy do |p|
  ...
  if Rails.env.development?
    ...
    p.connect_src :self, :data, :blob, *media_hosts, Rails.configuration.x.streaming_api_base_url, *front_end_build_urls, like_co, gad, mainnet_like, vercel, coingecko, like_pay, gam, gam_http
    p.script_src  :self, :unsafe_inline, :unsafe_eval, assets_host, ga, ga_http, gam, gam_http, gad
  else
    p.connect_src :self, :data, :blob, *media_hosts, Rails.configuration.x.streaming_api_base_url, like_co, gad, mainnet_like, vercel, coingecko, like_pay, gam, gam_http
    p.script_src  :self, assets_host, "'wasm-unsafe-eval'", ga, ga_http, gam, gam_http, gad
  end
end
