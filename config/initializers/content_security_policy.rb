...
Rails.application.config.content_security_policy do |p|
  ...
  if Rails.env.development?
    ...
    p.connect_src :self, :data, :blob, assets_host, js_cdn, like_co, mainnet_like, vercel, coingecko, like_pay, gam, gam_http, media_host, Rails.configuration.x.streaming_api_base_url, *webpacker_urls
    p.script_src  :self, :unsafe_inline, :unsafe_eval, assets_host, ga, ga_http, gam, gam_http
    p.child_src   :self, :blob, assets_host
    p.worker_src  :self, :blob, assets_host
  else
    p.connect_src :self, :data, :blob, assets_host, js_cdn, like_co, mainnet_like, coingecko, vercel, like_pay, gam, gam_http,media_host, like_co, Rails.configuration.x.streaming_api_base_url
